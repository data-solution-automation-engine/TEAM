...
IF OBJECT_ID('dbo.SAT_CUSTOMER_CONTACT_DETAILS', 'U') IS NOT NULL DROP TABLE dbo.SAT_CUSTOMER_CONTACT_DETAILS
...
-- BDV (source) view, created in separate SQL
IF OBJECT_ID('bdv.vw_CUSTOMER_DERIVED', 'V') IS NOT NULL DROP VIEW bdv.vw_CUSTOMER_DERIVED
...
(
  ...
  [STATE_TIMESTAMP] [datetime2](7) NOT NULL,
...
(
  ...
  [PREF_GENDER_PRONOUN] nvarchar(100) NULL,
...
CREATE TABLE dbo.SAT_CUSTOMER_CONTACT_DETAILS
(
  [CUSTOMER_SK] binary(16) NOT NULL,
  [INSCRIPTION_TIMESTAMP] [datetime2](7) NOT NULL,
  [INSCRIPTION_RECORD_ID] [int] NOT NULL,
  ...
  CONSTRAINT [PK_SAT_CUSTOMER_CONTACT_DETAILS] PRIMARY KEY CLUSTERED (CUSTOMER_SK ASC, [INSCRIPTION_TIMESTAMP] ASC, [INSCRIPTION_RECORD_ID] ASC)
)
...
-- BDV Satellite
IF OBJECT_ID('dbo.SAT_CUSTOMER_DERIVED', 'U') IS NOT NULL DROP TABLE dbo.SAT_CUSTOMER_DERIVED

CREATE TABLE [dbo].[SAT_CUSTOMER_DERIVED](
  [CUSTOMER_SK] [binary](16) NOT NULL,
  [INSCRIPTION_TIMESTAMP] [datetime2](7) NOT NULL,
  [INSCRIPTION_RECORD_ID] [int] NOT NULL,
  [STATE_TIMESTAMP] [datetime2](7) NOT NULL,
