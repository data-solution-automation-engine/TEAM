...
(
  ...
  CONSTRAINT [PK_LSAT_CUSTOMER_COSTING] PRIMARY KEY CLUSTERED (CUSTOMER_COSTING_SK ASC, LOAD_DATETIME ASC
...
(
  ...
  RECORD_SOURCE varchar(100) NOT NULL,
  HASH_FULL_RECORD binary(16) NOT NULL,
  CONSTRAINT [PK_LSAT_CUSTOMER_OFFER] PRIMARY KEY CLUSTERED (CUSTOMER_OFFER_SK ASC, LOAD_DATETIME ASC
)
)
...
(
  ...
  CONSTRAINT [PK_LSAT_MEMBERSHIP] PRIMARY KEY CLUSTERED (MEMBERSHIP_SK ASC, LOAD_DATETIME ASC
)
)
...
(
  ...
  CONSTRAINT [PK_SAT_CUSTOMER] PRIMARY KEY CLUSTERED (CUSTOMER_SK ASC, LOAD_DATETIME ASC
)
)
...
(
  ...
  CONSTRAINT [PK_SAT_CUSTOMER_ADDITIONAL_DETAILS] PRIMARY KEY CLUSTERED (CUSTOMER_SK ASC, LOAD_DATETIME ASC
)
)
...
(
  ...
  CONSTRAINT [PK_SAT_INCENTIVE_OFFER] PRIMARY KEY CLUSTERED(INCENTIVE_OFFER_SK ASC, LOAD_DATETIME ASC
)
)
...
(
  ...
  CONSTRAINT [PK_SAT_MEMBERSHIP_PLAN_DETAIL] PRIMARY KEY CLUSTERED(MEMBERSHIP_PLAN_SK ASC, LOAD_DATETIME ASC
)
)
...
(
  ...
  CONSTRAINT [PK_SAT_MEMBERSHIP_PLAN_VALUATION] PRIMARY KEY CLUSTERED(MEMBERSHIP_PLAN_SK ASC, LOAD_DATETIME ASC
...
(
  ...
  CONSTRAINT [PK_SAT_SEGMENT] PRIMARY KEY CLUSTERED (SEGMENT_SK ASC, LOAD_DATETIME ASC
)
)
