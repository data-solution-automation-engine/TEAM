...
(
  ...
  OMD_INSERT_MODULE_INSTANCE_ID integer NOT NULL,
  OMD_FIRST_SEEN_DATETIME datetime2(7) NOT NULL,
  [OMD_RECORD_SOURCE_ID] [int] NOT NULL,
...
(
  ...
  OMD_EFFECTIVE_DATETIME datetime2(7) NOT NULL,
  OMD_EXPIRY_DATETIME datetime2(7) NOT NULL,
  OMD_CURRENT_RECORD_INDICATOR varchar(100) NOT NULL,
  OMD_INSERT_MODULE_INSTANCE_ID integer NOT NULL,
  OMD_UPDATE_MODULE_INSTANCE_ID integer NOT NULL,
  OMD_CDC_OPERATION varchar(100) NOT NULL,
  OMD_SOURCE_ROW_ID integer NOT NULL,
  [OMD_RECORD_SOURCE_ID] [int] NOT NULL,
  OMD_HASH_FULL_RECORD binary(16) NOT NULL,
  PERSONAL_MONTHLY_COST numeric(38,20) NULL,
  CONSTRAINT [PK_LSAT_CUSTOMER_COSTING] PRIMARY KEY CLUSTERED (CUSTOMER_COSTING_SK ASC, OMD_EFFECTIVE_DATETIME ASC
...
(
  ...
  [OMD_RECORD_SOURCE_ID] [int] NOT NULL,
  OMD_HASH_FULL_RECORD binary(16) NOT NULL,
  CONSTRAINT [PK_LSAT_CUSTOMER_OFFER] PRIMARY KEY CLUSTERED (CUSTOMER_OFFER_SK ASC, OMD_EFFECTIVE_DATETIME ASC
)
)
...
(
  ...
  CONSTRAINT [PK_LSAT_MEMBERSHIP] PRIMARY KEY CLUSTERED (MEMBERSHIP_SK ASC, OMD_EFFECTIVE_DATETIME ASC
)
)
...
(
  ...
  CONSTRAINT [PK_SAT_CUSTOMER] PRIMARY KEY CLUSTERED (CUSTOMER_SK ASC, OMD_EFFECTIVE_DATETIME ASC
)
)
...
(
  ...
  CONSTRAINT [PK_SAT_CUSTOMER_ADDITIONAL_DETAILS] PRIMARY KEY CLUSTERED (CUSTOMER_SK ASC, OMD_EFFECTIVE_DATETIME ASC
)
)
...
(
  ...
  CONSTRAINT [PK_SAT_INCENTIVE_OFFER] PRIMARY KEY CLUSTERED(INCENTIVE_OFFER_SK ASC, OMD_EFFECTIVE_DATETIME ASC
)
)
...
(
  ...
  CONSTRAINT [PK_SAT_MEMBERSHIP_PLAN_DETAIL] PRIMARY KEY CLUSTERED(MEMBERSHIP_PLAN_SK ASC, OMD_EFFECTIVE_DATETIME ASC
)
)
...
(
  ...
  CONSTRAINT [PK_SAT_MEMBERSHIP_PLAN_VALUATION] PRIMARY KEY CLUSTERED(MEMBERSHIP_PLAN_SK ASC, OMD_EFFECTIVE_DATETIME ASC
...
(
  ...
  CONSTRAINT [PK_SAT_SEGMENT] PRIMARY KEY CLUSTERED (SEGMENT_SK ASC, OMD_EFFECTIVE_DATETIME ASC
)
)
